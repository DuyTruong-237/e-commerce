                                                    ...
                                                    <div class="s4eg4A">
                                                        <div class="stardust-radio-group" role="radiogroup">
                                                            <div class="stardust-radio" tabindex="0" role="radio"
                                                                aria-checked="false">
                                                                <label>
                                                                    <input class="radioGender" type="radio" name="gender" value="male" />
                                                                      Male
                                                                </label>
                                                            </div>
                                                            <div class="stardust-radio stardust-radio--checked" tabindex="0"
                                                                ...
                                                                <label>
                                                                    <input class="radioGender" type="radio" name="gender" value="female" />
                                                                      Female
                                                                </label>
                                                            </div>
                                                            <div class="stardust-radio" tabindex="0" role="radio"
                                                                aria-checked="false">
                                                                    <label>
                                                                    <input class="radioGender" type="radio" name="gender" value="others" />
                                                                      Others
                                                                </label>
                                                            </div>
                                                        </div>
